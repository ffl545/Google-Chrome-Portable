...
采用GitHub Actions自动编译发布，下载地址：[https://nightly.link/zzp198/Google-Chrome-Portable/workflows/build/main?preview](https://nightly.link/zzp198/Google-Chrome-Portable/workflows/build/main?preview)
